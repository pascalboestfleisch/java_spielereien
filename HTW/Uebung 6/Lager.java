...
public class Lager{
   ...
   /**
    * Ueberprueft ob die Lagerkapazitaet gueltig ist
    * @artikelAnzahl Ueberprueft das Lager darauf wie viele Artikel momentan enthalten sind
    */
   ...
   /**
    * Bestandsliste ausgeben lassen von Objekten, welche im Lager sind
    * @return gibt die Bestandsliste wieder
    */
   public String ausgebenBestandsListe() {
       for(Artikel artikel: this.artikelArray){
           if(artikel != null){
                artikel.ausgebenBestandsListe();
           }
       }
